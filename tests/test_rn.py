...
test_data = [
    ...
    # 辞書順記数法
    ['"_9"', rn.num('_9'), 'O_9o0', (-1, 0)],
    ['"A10"', rn.num('A10'), 'OA10o0', (10, 0)],

    # 数珠玉記数法
    ['"O_9"', rn.num('O_9'), 'O_9o0', (-1, 0)],
    ['"OA10"', rn.num('OA10'), 'OA10o0', (10, 0)],
    ['"O_9o1oA10"', rn.num('O_9o1oA10'), 'O_9o1oA10o0', (-1, 1, 10, 0)],
    ...
    # O1o2 の形
    ['"O1o2o_9"', rn.num('O1o2o_9'), 'O1o2o_9o0', (1, 2, -1, 0)],
    ['"O1o2"', rn.num('O1o2'), 'O1o2o0', (1, 2, 0)],
    ['"O1o2oA10o4"', rn.num('O1o2oA10o4'), 'O1o2oA10o4o0', (1, 2, 10, 4, 0)],
    ...
    # 拡張: 辞書順記数法への寛容
    ['"A77"', rn.num('A77'), 'OA77o0', (77, 0)],
    ['"AA777"', rn.num('AA777'), 'OAA777o0', (777, 0)],
    ...
    # タプル
    ['(1,2)', rn.num((1, 2)), 'O1o2o0', (1, 2, 0)],
    ['(1,2,-3)', rn.num((1, 2, -3)), 'O1o2o_7o0', (1, 2, -3, 0)],
    ['(1,2,10,4)', rn.num((1, 2, 10, 4)), 'O1o2oA10o4o0', (1, 2, 10, 4, 0)],
